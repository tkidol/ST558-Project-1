...
kable(PL_SK_Season, caption = "Preview of 2017 - 2019 Team Rosters: Presidents Cup vs Last Place")
```
...
# Finish by TP Rank
FxPosplot <- ggplot(PL_SK_Season, aes(Finish, fill = as.factor(Position)))
FxPosplot + geom_bar(position = "dodge") +  scale_fill_discrete(name = "Position") + labs(x = "Team Finish")
```
...
```{r, dotplot by }
# Base plot aesthetic with Total Points on x axis
g <- ggplot(PL_SK_Season, aes(x = Avg_Penalty_Min, y = Avg_Total_Points, color = Finish))
